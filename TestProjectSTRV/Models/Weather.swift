...
struct Weather {
    ...
    static let icons = ["01d":#imageLiteral(resourceName: "Sun_Big"), "01n": #imageLiteral(resourceName: "Sun_Big"), "02d": #imageLiteral(resourceName: "Cloudy_Big"), "03d": #imageLiteral(resourceName: "Cloudy_Big"), "04d": #imageLiteral(resourceName: "Cloudy_Big"), "09d": #imageLiteral(resourceName: "rainy"), "10d": #imageLiteral(resourceName: "rainy"), "11d": #imageLiteral(resourceName: "CL"), "13d": #imageLiteral(resourceName: "CL")]
